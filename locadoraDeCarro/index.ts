...
import { CarRepository} from "./controlers";

const carRepository = new CarRepository()

//const newCar: Car = {model:"Fusca",releasedAt: 2018,brand: 'BMW',price:250.000,status:'rented'}
//carRepository.create(newCar)

//const newCar: Car = {model:"237",releasedAt: 2018,brand: 'wv',price:50.000,status:"available"}
//carRepository.create(newCar)

carRepository.updateStatus('65f4be76ad3c6d873a15a9f7',"rented")
